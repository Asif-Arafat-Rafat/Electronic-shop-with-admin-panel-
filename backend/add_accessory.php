...
// Check if all form fields are set
    ...
    if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        $folder = '../images/access/' . $file;

        // Prepare and execute the SQL query
        $regi = $conn->prepare("INSERT INTO product_section(label1,info1,label2,info2,label3,info3,label4,info4,label5,info5, quantity, price, image,type) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,'access')");
